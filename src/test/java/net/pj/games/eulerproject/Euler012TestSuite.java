...
public class Euler012TestSuite {
	...
	public void testTrianglesPrimeMatrix() {
		...
		for (int t = 2; t < deep; t++) {
			...
			StringBuffer triangleRenderer = new StringBuffer();
			triangleRenderer.append(t).append("\t");
			
			triangleRenderer.append(String.format("%1$-8s", triangle.toString()));
	...
	public void solution() {
            ...
            log.info("{} Diviseurs : {}", dividers, dividersList.toString());
